...
#         data.append({"doc": f"content_text": {content_text}})
...
#     API_KEY = "AIzaSyBH3U3a0rNeNz0EOybgWMfquFJRGirb2O8"
#     CSE_ID = "15a035189dd23497a"
#     search_term = "Pantaprazole"
#     data = search_and_scrape(search_term, API_KEY, CSE_ID)
#     print(data)
